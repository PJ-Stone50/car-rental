      ...
      >
        ...
        >
          <div
            className={
              isTablet
                ? "w-fit h-fit flex gap-3 bg-white mx-[1rem]  rounded-lg  px-5   pb-[5rem]  absolute top-[20%] p-4 shadow-lg z-10"
          ...
          >
            ...
            >
              <div
                className={
                  isTablet
                    ? "w-full h-fit whitespace-nowrap cursor-pointer flex flex-col rounded-sm bg-[#F3F6F9] py-3 px-2 pr-[10rem] border-[1.5px] border-[#E0E3E7]"
                    : "w-full h-fit whitespace-nowrap cursor-pointer  flex flex-col rounded-sm bg-[#F3F6F9] p-3 border-[1.5px] border-[#E0E3E7]"
                }
              >
                {sameLocation ? (
