    ...
    <div className="flex w-full justify-start z-0">
      ...
      >
        <div
          className={
            isTablet
              ? "w-full h-fit pl-[1.25rem] whitespace-nowrap cursor-pointer flex flex-col rounded bg-[#F3F6F9] py-3 px-2 pr-[10rem] border-[1.5px] border-[#E0E3E7]"
              : "w-full h-fit pl-[1.25rem] whitespace-nowrap cursor-pointer  flex flex-col rounded bg-[#F3F6F9] p-3 border-[1.5px] border-[#E0E3E7]"
          }
        >
          {sameLocation ? (
            <h1 className="text-[14px] text-[#424242] ">สถานที่รับและคืนรถ</h1>
          ) : (
            <h1 className="opacity-80 text-[#424242]">สถานที่รับรถ</h1>
          )}
          {pickupLocation ? (
